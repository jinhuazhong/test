...
#weights = os.path.join(config.checkpoints_dir, 'voc_ctpn_ep28_0.0481_0.1294_0.1775.pth')
weights = os.path.join(config.checkpoints_dir, 'D:/TASK/ocr-pdf/checkpoints/CTPN.pth')
model = CTPN_Model()
